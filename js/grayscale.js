    ...
    $(function() {
        $(window).scroll(function() {    
            ...
            if (scroll >= 1100) {
                ...
                $(".skill li span.five").addClass("python");
                $(".skill li span.six").addClass("android");
                $(".skill li span.seven").addClass("sqlite");
            }
        });
    });
...
function init() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(22.319312, 87.309959), // New York
    ...
    var myLatLng = new google.maps.LatLng( 22.319312, 87.309959);
